...
- <code title="post /api/v1/products/{id}/duplicate">client.v1.products.<a href="./src/stigg/resources/v1/products.py">duplicate_product</a>(id, \*\*<a href="src/stigg/types/v1/product_duplicate_product_params.py">params</a>) -> <a href="./src/stigg/types/v1/product_duplicate_product_response.py">ProductDuplicateProductResponse</a></code>
