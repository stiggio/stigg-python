...
class Stigg(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Stigg client instance.

        This automatically infers the `api_key` argument from the `STIGG_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
...
class AsyncStigg(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncStigg client instance.
