...
from .....types.v1.events.plans import entitlement_create_params, entitlement_update_params
from .....types.v1.events.plans.plan_entitlement import PlanEntitlement
from .....types.v1.events.plans.entitlement_list_response import EntitlementListResponse
from .....types.v1.events.plans.entitlement_create_response import EntitlementCreateResponse
...
class EntitlementsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/plans/{plan_id}/entitlements",
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            f"/api/v1/plans/{plan_id}/entitlements/{id}",
