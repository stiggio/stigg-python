...
from ....types.v1 import credit_get_usage_params, credit_list_ledger_params
...
from .auto_recharge import (
    AutoRechargeResource,
    AsyncAutoRechargeResource,
    AutoRechargeResourceWithRawResponse,
    AsyncAutoRechargeResourceWithRawResponse,
    AutoRechargeResourceWithStreamingResponse,
    AsyncAutoRechargeResourceWithStreamingResponse,
)
...
class CreditsResource(SyncAPIResource):
    ...
    @cached_property
    def auto_recharge(self) -> AutoRechargeResource:
        return AutoRechargeResource(self._client)
...
class AsyncCreditsResource(AsyncAPIResource):
    ...
    @cached_property
    def auto_recharge(self) -> AsyncAutoRechargeResource:
        return AsyncAutoRechargeResource(self._client)
...
class CreditsResourceWithRawResponse:
    ...
    @cached_property
    def auto_recharge(self) -> AutoRechargeResourceWithRawResponse:
        return AutoRechargeResourceWithRawResponse(self._credits.auto_recharge)
...
class AsyncCreditsResourceWithRawResponse:
    ...
    @cached_property
    def auto_recharge(self) -> AsyncAutoRechargeResourceWithRawResponse:
        return AsyncAutoRechargeResourceWithRawResponse(self._credits.auto_recharge)
...
class CreditsResourceWithStreamingResponse:
    ...
    @cached_property
    def auto_recharge(self) -> AutoRechargeResourceWithStreamingResponse:
        return AutoRechargeResourceWithStreamingResponse(self._credits.auto_recharge)
...
class AsyncCreditsResourceWithStreamingResponse:
    ...
    @cached_property
    def auto_recharge(self) -> AsyncAutoRechargeResourceWithStreamingResponse:
        return AsyncAutoRechargeResourceWithStreamingResponse(self._credits.auto_recharge)
