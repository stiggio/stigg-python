...
from ....types.v1.plans import entitlement_create_params, entitlement_update_params
from ....types.v1.plans.plan_entitlement import PlanEntitlement
from ....types.v1.plans.entitlement_list_response import EntitlementListResponse
from ....types.v1.plans.entitlement_create_response import EntitlementCreateResponse
...
class EntitlementsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            path_template("/api/v1/plans/{plan_id}/entitlements", plan_id=plan_id),
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template("/api/v1/plans/{plan_id}/entitlements/{id}", plan_id=plan_id, id=id),
