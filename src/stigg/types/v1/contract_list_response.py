...
__all__ = ["ContractListResponse", "LatestInvoice", "NextInvoice", "NextInvoiceAmount", "Subscription"]
...
class NextInvoiceAmount(BaseModel):
...
class ContractListResponse(BaseModel):
    ...
    next_invoice: Optional[NextInvoice] = FieldInfo(alias="nextInvoice", default=None)
    """A preview of the contract's upcoming invoice, or null when none is available"""
