...
__all__ = [
    ...
    "ResetPeriodConfigurationYearlyResetPeriodConfig",
    "ResetPeriodConfigurationMonthlyResetPeriodConfig",
    "ResetPeriodConfigurationWeeklyResetPeriodConfig",
]


class ResetPeriodConfigurationYearlyResetPeriodConfig(BaseModel):
...
class ResetPeriodConfigurationMonthlyResetPeriodConfig(BaseModel):
...
class ResetPeriodConfigurationWeeklyResetPeriodConfig(BaseModel):
...
ResetPeriodConfiguration: TypeAlias = Union[
    ResetPeriodConfigurationYearlyResetPeriodConfig,
    ResetPeriodConfigurationMonthlyResetPeriodConfig,
    ResetPeriodConfigurationWeeklyResetPeriodConfig,
    None,
...
class PromotionalEntitlementListResponse(BaseModel):
    """A feature entitlement granted to a customer outside of their subscription plan.

    Promotional entitlements are applied on top of whatever the subscription already grants and are not removed when a plan or subscription changes; once past their end date they keep appearing in the customer's entitlement list with an Expired status rather than disappearing.
    """
    ...
    reset_period_configuration: Optional[ResetPeriodConfiguration] = FieldInfo(
