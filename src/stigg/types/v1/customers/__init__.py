...
from .promotional_entitlement_list_response import (
    PromotionalEntitlementListResponse as PromotionalEntitlementListResponse,
)
from .promotional_entitlement_create_response import (
    PromotionalEntitlementCreateResponse as PromotionalEntitlementCreateResponse,
)
from .promotional_entitlement_revoke_response import (
    PromotionalEntitlementRevokeResponse as PromotionalEntitlementRevokeResponse,
)
