...
class SyncMyCursorIDPage(BaseSyncPage[_T], BasePage[_T], Generic[_T]):
    ...
    def next_page_info(self) -> Optional[PageInfo]:
        ...
        if is_forwards:
            ...
            if not isinstance(item, MyCursorIDPageItem) or item.cursor_id is None:  # pyright: ignore[reportUnnecessaryComparison]
                # TODO emit warning log
                return None

            return PageInfo(params={"starting_after": item.cursor_id})
        else:
            ...
            return PageInfo(params={"ending_before": item.cursor_id})
