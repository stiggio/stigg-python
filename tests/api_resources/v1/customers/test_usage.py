...
class TestUsage:
    ...
    def test_method_retrieve(self, client: Stigg) -> None:
        usage = client.v1.customers.usage.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Stigg) -> None:
        response = client.v1.customers.usage.with_raw_response.retrieve(
            feature_id="featureId",
            customer_id="customerId",
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_retrieve(self, client: Stigg) -> None:
        with client.v1.customers.usage.with_streaming_response.retrieve(
            feature_id="featureId",
            customer_id="customerId",
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `customer_id` but received ''"):
            client.v1.customers.usage.with_raw_response.retrieve(
                feature_id="featureId",
                customer_id="",
                start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            )
...
class TestAsyncUsage:
    ...
    async def test_method_retrieve(self, async_client: AsyncStigg) -> None:
        usage = await async_client.v1.customers.usage.retrieve(
            feature_id="featureId",
            customer_id="customerId",
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.customers.usage.with_raw_response.retrieve(
            feature_id="featureId",
            customer_id="customerId",
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.customers.usage.with_streaming_response.retrieve(
            feature_id="featureId",
            customer_id="customerId",
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    async def test_path_params_retrieve(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `customer_id` but received ''"):
            await async_client.v1.customers.usage.with_raw_response.retrieve(
                feature_id="featureId",
                customer_id="",
                start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            )
