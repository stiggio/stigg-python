...
from stigg.types.v1.plans import (
    PlanEntitlement,
...
class TestEntitlements:
    ...
    def test_raw_response_delete(self, client: Stigg) -> None:
        response = client.v1.plans.entitlements.with_raw_response.delete(
            id="id",
            plan_id="planId",
        )
    ...
    def test_streaming_response_delete(self, client: Stigg) -> None:
        with client.v1.plans.entitlements.with_streaming_response.delete(
            id="id",
            plan_id="planId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            client.v1.plans.entitlements.with_raw_response.delete(
                id="id",
                plan_id="",
            )
...
class TestAsyncEntitlements:
    ...
    async def test_raw_response_delete(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.plans.entitlements.with_raw_response.delete(
            id="id",
            plan_id="planId",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.plans.entitlements.with_streaming_response.delete(
            id="id",
            plan_id="planId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            await async_client.v1.plans.entitlements.with_raw_response.delete(
                id="id",
                plan_id="",
            )
