...
class TestCustomers:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_check_entitlement(self, client: Stigg) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_check_entitlement(self, client: Stigg) -> None:
        response = client.v1.customers.with_raw_response.check_entitlement(
            id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_check_entitlement(self, client: Stigg) -> None:
        with client.v1.customers.with_streaming_response.check_entitlement(
            id="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_check_entitlement(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v1.customers.with_raw_response.check_entitlement(
                id="",
            )
...
class TestAsyncCustomers:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_check_entitlement(self, async_client: AsyncStigg) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_check_entitlement(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.customers.with_raw_response.check_entitlement(
            id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_check_entitlement(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.customers.with_streaming_response.check_entitlement(
            id="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_check_entitlement(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v1.customers.with_raw_response.check_entitlement(
                id="",
            )
