...
class TestEntitlements:
    ...
    def test_method_create(self, client: Stigg) -> None:
        entitlement = client.v1.events.plans.entitlements.create(
            plan_id="planId",
            entitlements=[{}],
        )
    ...
    def test_raw_response_create(self, client: Stigg) -> None:
        response = client.v1.events.plans.entitlements.with_raw_response.create(
            plan_id="planId",
            entitlements=[{}],
        )
    ...
    def test_streaming_response_create(self, client: Stigg) -> None:
        with client.v1.events.plans.entitlements.with_streaming_response.create(
            plan_id="planId",
            entitlements=[{}],
        ) as response:
    ...
    def test_path_params_create(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            client.v1.events.plans.entitlements.with_raw_response.create(
                plan_id="",
                entitlements=[{}],
            )
    ...
    def test_method_update(self, client: Stigg) -> None:
        entitlement = client.v1.events.plans.entitlements.update(
            id="id",
            plan_id="planId",
        )
    ...
    def test_raw_response_update(self, client: Stigg) -> None:
        response = client.v1.events.plans.entitlements.with_raw_response.update(
            id="id",
            plan_id="planId",
        )
    ...
    def test_streaming_response_update(self, client: Stigg) -> None:
        with client.v1.events.plans.entitlements.with_streaming_response.update(
            id="id",
            plan_id="planId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            client.v1.events.plans.entitlements.with_raw_response.update(
                id="id",
                plan_id="",
            )
    ...
    def test_method_list(self, client: Stigg) -> None:
        entitlement = client.v1.events.plans.entitlements.list(
            "planId",
        )
    ...
    def test_raw_response_list(self, client: Stigg) -> None:
        response = client.v1.events.plans.entitlements.with_raw_response.list(
            "planId",
        )
    ...
    def test_streaming_response_list(self, client: Stigg) -> None:
        with client.v1.events.plans.entitlements.with_streaming_response.list(
            "planId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            client.v1.events.plans.entitlements.with_raw_response.list(
                "",
            )
    ...
    def test_method_delete(self, client: Stigg) -> None:
        entitlement = client.v1.events.plans.entitlements.delete(
            id="id",
            plan_id="planId",
        )
        assert_matches_type(PlanEntitlement, entitlement, path=["response"])
    ...
    def test_raw_response_delete(self, client: Stigg) -> None:
        response = client.v1.events.plans.entitlements.with_raw_response.delete(
            id="id",
            plan_id="planId",
        )
    ...
    def test_streaming_response_delete(self, client: Stigg) -> None:
        with client.v1.events.plans.entitlements.with_streaming_response.delete(
            id="id",
            plan_id="planId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            client.v1.events.plans.entitlements.with_raw_response.delete(
                id="id",
                plan_id="",
            )
...
class TestAsyncEntitlements:
    ...
    async def test_method_create(self, async_client: AsyncStigg) -> None:
        entitlement = await async_client.v1.events.plans.entitlements.create(
            plan_id="planId",
            entitlements=[{}],
        )
        assert_matches_type(EntitlementCreateResponse, entitlement, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.plans.entitlements.with_raw_response.create(
            plan_id="planId",
            entitlements=[{}],
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.plans.entitlements.with_streaming_response.create(
            plan_id="planId",
            entitlements=[{}],
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            await async_client.v1.events.plans.entitlements.with_raw_response.create(
                plan_id="",
                entitlements=[{}],
            )
    ...
    async def test_method_update(self, async_client: AsyncStigg) -> None:
        entitlement = await async_client.v1.events.plans.entitlements.update(
            id="id",
            plan_id="planId",
        )
        assert_matches_type(PlanEntitlement, entitlement, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.plans.entitlements.with_raw_response.update(
            id="id",
            plan_id="planId",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.plans.entitlements.with_streaming_response.update(
            id="id",
            plan_id="planId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            await async_client.v1.events.plans.entitlements.with_raw_response.update(
                id="id",
                plan_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncStigg) -> None:
        entitlement = await async_client.v1.events.plans.entitlements.list(
            "planId",
        )
        assert_matches_type(EntitlementListResponse, entitlement, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.plans.entitlements.with_raw_response.list(
            "planId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.plans.entitlements.with_streaming_response.list(
            "planId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            await async_client.v1.events.plans.entitlements.with_raw_response.list(
                "",
            )
    ...
    async def test_method_delete(self, async_client: AsyncStigg) -> None:
        entitlement = await async_client.v1.events.plans.entitlements.delete(
            id="id",
            plan_id="planId",
        )
        assert_matches_type(PlanEntitlement, entitlement, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.plans.entitlements.with_raw_response.delete(
            id="id",
            plan_id="planId",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.plans.entitlements.with_streaming_response.delete(
            id="id",
            plan_id="planId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `plan_id` but received ''"):
            await async_client.v1.events.plans.entitlements.with_raw_response.delete(
                id="id",
                plan_id="",
            )
