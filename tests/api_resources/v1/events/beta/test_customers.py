...
class TestCustomers:
    ...
    def test_method_retrieve_governance(self, client: Stigg) -> None:
        customer = client.v1.events.beta.customers.retrieve_governance(
            id="id",
        )
    ...
    def test_raw_response_retrieve_governance(self, client: Stigg) -> None:
        response = client.v1.events.beta.customers.with_raw_response.retrieve_governance(
            id="id",
        )
    ...
    def test_streaming_response_retrieve_governance(self, client: Stigg) -> None:
        with client.v1.events.beta.customers.with_streaming_response.retrieve_governance(
            id="id",
        ) as response:
    ...
    def test_path_params_retrieve_governance(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.v1.events.beta.customers.with_raw_response.retrieve_governance(
                id="",
            )
...
class TestAsyncCustomers:
    ...
    async def test_method_retrieve_governance(self, async_client: AsyncStigg) -> None:
        customer = await async_client.v1.events.beta.customers.retrieve_governance(
            id="id",
        )
        assert_matches_type(CustomerRetrieveGovernanceResponse, customer, path=["response"])
    ...
    async def test_raw_response_retrieve_governance(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.beta.customers.with_raw_response.retrieve_governance(
            id="id",
        )
    ...
    async def test_streaming_response_retrieve_governance(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.beta.customers.with_streaming_response.retrieve_governance(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_governance(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.v1.events.beta.customers.with_raw_response.retrieve_governance(
                id="",
            )
