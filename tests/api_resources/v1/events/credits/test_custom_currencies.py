...
class TestCustomCurrencies:
    ...
    def test_method_create(self, client: Stigg) -> None:
        ...
        assert_matches_type(CustomCurrencyCreateResponse, custom_currency, path=["response"])
    ...
    def test_raw_response_create(self, client: Stigg) -> None:
        response = client.v1.events.credits.custom_currencies.with_raw_response.create(
            id="id",
            display_name="displayName",
        )
    ...
    def test_streaming_response_create(self, client: Stigg) -> None:
        with client.v1.events.credits.custom_currencies.with_streaming_response.create(
            id="id",
            display_name="displayName",
        ) as response:
    ...
    def test_method_update(self, client: Stigg) -> None:
        ...
        assert_matches_type(CustomCurrencyUpdateResponse, custom_currency, path=["response"])
    ...
    def test_raw_response_update(self, client: Stigg) -> None:
        response = client.v1.events.credits.custom_currencies.with_raw_response.update(
            currency_id="currencyId",
        )
    ...
    def test_streaming_response_update(self, client: Stigg) -> None:
        with client.v1.events.credits.custom_currencies.with_streaming_response.update(
            currency_id="currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            client.v1.events.credits.custom_currencies.with_raw_response.update(
                currency_id="",
            )
    ...
    def test_method_list(self, client: Stigg) -> None:
        custom_currency = client.v1.events.credits.custom_currencies.list()
    ...
    def test_raw_response_list(self, client: Stigg) -> None:
        response = client.v1.events.credits.custom_currencies.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Stigg) -> None:
        with client.v1.events.credits.custom_currencies.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_archive(self, client: Stigg) -> None:
        custom_currency = client.v1.events.credits.custom_currencies.archive(
            "currencyId",
        )
        assert_matches_type(CustomCurrencyArchiveResponse, custom_currency, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_archive(self, client: Stigg) -> None:
        response = client.v1.events.credits.custom_currencies.with_raw_response.archive(
            "currencyId",
        )
    ...
    def test_streaming_response_archive(self, client: Stigg) -> None:
        with client.v1.events.credits.custom_currencies.with_streaming_response.archive(
            "currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_archive(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            client.v1.events.credits.custom_currencies.with_raw_response.archive(
                "",
            )
    ...
    def test_method_list_associated_entities(self, client: Stigg) -> None:
        custom_currency = client.v1.events.credits.custom_currencies.list_associated_entities(
            "currencyId",
        )
    ...
    def test_raw_response_list_associated_entities(self, client: Stigg) -> None:
        response = client.v1.events.credits.custom_currencies.with_raw_response.list_associated_entities(
            "currencyId",
        )
    ...
    def test_streaming_response_list_associated_entities(self, client: Stigg) -> None:
        with client.v1.events.credits.custom_currencies.with_streaming_response.list_associated_entities(
            "currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_associated_entities(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            client.v1.events.credits.custom_currencies.with_raw_response.list_associated_entities(
                "",
            )
    ...
    def test_method_unarchive(self, client: Stigg) -> None:
        custom_currency = client.v1.events.credits.custom_currencies.unarchive(
            "currencyId",
        )
        assert_matches_type(CustomCurrencyUnarchiveResponse, custom_currency, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_unarchive(self, client: Stigg) -> None:
        response = client.v1.events.credits.custom_currencies.with_raw_response.unarchive(
            "currencyId",
        )
    ...
    def test_streaming_response_unarchive(self, client: Stigg) -> None:
        with client.v1.events.credits.custom_currencies.with_streaming_response.unarchive(
            "currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_unarchive(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            client.v1.events.credits.custom_currencies.with_raw_response.unarchive(
                "",
            )
...
class TestAsyncCustomCurrencies:
    ...
    async def test_method_create(self, async_client: AsyncStigg) -> None:
        custom_currency = await async_client.v1.events.credits.custom_currencies.create(
            id="id",
            display_name="displayName",
        )
        assert_matches_type(CustomCurrencyCreateResponse, custom_currency, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.credits.custom_currencies.with_raw_response.create(
            id="id",
            display_name="displayName",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.credits.custom_currencies.with_streaming_response.create(
            id="id",
            display_name="displayName",
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_update(self, async_client: AsyncStigg) -> None:
        custom_currency = await async_client.v1.events.credits.custom_currencies.update(
            currency_id="currencyId",
        )
        assert_matches_type(CustomCurrencyUpdateResponse, custom_currency, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.credits.custom_currencies.with_raw_response.update(
            currency_id="currencyId",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.credits.custom_currencies.with_streaming_response.update(
            currency_id="currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            await async_client.v1.events.credits.custom_currencies.with_raw_response.update(
                currency_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncStigg) -> None:
        custom_currency = await async_client.v1.events.credits.custom_currencies.list()
    ...
    async def test_raw_response_list(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.credits.custom_currencies.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.credits.custom_currencies.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_archive(self, async_client: AsyncStigg) -> None:
        custom_currency = await async_client.v1.events.credits.custom_currencies.archive(
            "currencyId",
        )
        assert_matches_type(CustomCurrencyArchiveResponse, custom_currency, path=["response"])
    ...
    async def test_raw_response_archive(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.credits.custom_currencies.with_raw_response.archive(
            "currencyId",
        )
    ...
    async def test_streaming_response_archive(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.credits.custom_currencies.with_streaming_response.archive(
            "currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_archive(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            await async_client.v1.events.credits.custom_currencies.with_raw_response.archive(
                "",
            )
    ...
    async def test_method_list_associated_entities(self, async_client: AsyncStigg) -> None:
        custom_currency = await async_client.v1.events.credits.custom_currencies.list_associated_entities(
            "currencyId",
        )
        assert_matches_type(CustomCurrencyListAssociatedEntitiesResponse, custom_currency, path=["response"])
    ...
    async def test_raw_response_list_associated_entities(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.credits.custom_currencies.with_raw_response.list_associated_entities(
            "currencyId",
        )
    ...
    async def test_streaming_response_list_associated_entities(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.credits.custom_currencies.with_streaming_response.list_associated_entities(
            "currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_associated_entities(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            await async_client.v1.events.credits.custom_currencies.with_raw_response.list_associated_entities(
                "",
            )
    ...
    async def test_method_unarchive(self, async_client: AsyncStigg) -> None:
        custom_currency = await async_client.v1.events.credits.custom_currencies.unarchive(
            "currencyId",
        )
        assert_matches_type(CustomCurrencyUnarchiveResponse, custom_currency, path=["response"])
    ...
    async def test_raw_response_unarchive(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.credits.custom_currencies.with_raw_response.unarchive(
            "currencyId",
        )
    ...
    async def test_streaming_response_unarchive(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.credits.custom_currencies.with_streaming_response.unarchive(
            "currencyId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_unarchive(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `currency_id` but received ''"):
            await async_client.v1.events.credits.custom_currencies.with_raw_response.unarchive(
                "",
            )
