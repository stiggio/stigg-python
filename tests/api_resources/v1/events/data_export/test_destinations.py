...
class TestDestinations:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_update_selection(self, client: Stigg) -> None:
        destination = client.v1.events.data_export.destinations.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
        )
        assert_matches_type(DestinationUpdateSelectionResponse, destination, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_update_selection_with_all_params(self, client: Stigg) -> None:
        destination = client.v1.events.data_export.destinations.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_update_selection(self, client: Stigg) -> None:
        response = client.v1.events.data_export.destinations.with_raw_response.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_update_selection(self, client: Stigg) -> None:
        with client.v1.events.data_export.destinations.with_streaming_response.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
        ) as response:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_update_selection(self, client: Stigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `destination_id` but received ''"):
            client.v1.events.data_export.destinations.with_raw_response.update_selection(
                destination_id="",
                enabled_models=["x"],
                integration_id="x",
            )
...
class TestAsyncDestinations:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_update_selection(self, async_client: AsyncStigg) -> None:
        destination = await async_client.v1.events.data_export.destinations.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_update_selection_with_all_params(self, async_client: AsyncStigg) -> None:
        destination = await async_client.v1.events.data_export.destinations.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_update_selection(self, async_client: AsyncStigg) -> None:
        response = await async_client.v1.events.data_export.destinations.with_raw_response.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_update_selection(self, async_client: AsyncStigg) -> None:
        async with async_client.v1.events.data_export.destinations.with_streaming_response.update_selection(
            destination_id="x",
            enabled_models=["x"],
            integration_id="x",
        ) as response:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_update_selection(self, async_client: AsyncStigg) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `destination_id` but received ''"):
            await async_client.v1.events.data_export.destinations.with_raw_response.update_selection(
                destination_id="",
                enabled_models=["x"],
                integration_id="x",
            )
