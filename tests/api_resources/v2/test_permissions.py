...
class TestPermissions:
    ...
    def test_method_check(self, client: Stigg) -> None:
        permission = client.v2.permissions.check(
            user_id="userId",
    ...
    def test_raw_response_check(self, client: Stigg) -> None:
        response = client.v2.permissions.with_raw_response.check(
            user_id="userId",
            resources_and_actions=[
                {
                    "action": "read",
    ...
    def test_streaming_response_check(self, client: Stigg) -> None:
        with client.v2.permissions.with_streaming_response.check(
            user_id="userId",
            resources_and_actions=[
                {
                    "action": "read",
...
class TestAsyncPermissions:
    ...
    async def test_method_check(self, async_client: AsyncStigg) -> None:
        permission = await async_client.v2.permissions.check(
            user_id="userId",
            resources_and_actions=[
                {
                    "action": "read",
    ...
    async def test_raw_response_check(self, async_client: AsyncStigg) -> None:
        response = await async_client.v2.permissions.with_raw_response.check(
            user_id="userId",
            resources_and_actions=[
                {
                    "action": "read",
    ...
    async def test_streaming_response_check(self, async_client: AsyncStigg) -> None:
        async with async_client.v2.permissions.with_streaming_response.check(
            user_id="userId",
            resources_and_actions=[
                {
                    "action": "read",
